  ...
  public GTable() {
        ...
        if (e.getClickCount() == 1) {
          ...
          if(column == 0){
            if(dtm.getValueAt(currentRow,0).equals(true)){
              ...
              JOptionPane.showMessageDialog(null, "Task Marked Incomplete", "Done Window", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
              dtm.setValueAt(true, currentRow, 0);
              JOptionPane.showMessageDialog(null, "Task Marked Done", "Done Window", JOptionPane.INFORMATION_MESSAGE);
            }
          }
        }
      }
    ...
    btnDelete.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent arg0) {
        int currentRow = table.convertRowIndexToModel(table.getSelectedRow());
        if(currentRow == -1){
          JOptionPane.showMessageDialog(null, "No Task Selected", "Delete Message", JOptionPane.WARNING_MESSAGE);
        }
        else{
